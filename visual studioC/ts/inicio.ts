/*variables*/
let formulario:any=document.getElementById("form");
...
/*validaciones*/
function validarRut(formulario:any){
    let rut = formulario[2].value;
...
function validarTelefono(formulario){
    let telefono:any = formulario[5].value;
...
/*funcion del mensaje */
function Mensaje(mensaje:any,formulario:any){
